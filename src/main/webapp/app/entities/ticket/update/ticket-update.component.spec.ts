...
describe('Ticket Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Project query and add missing value', () => {
      ...
      const project: IProject = { id: 10976 };
      ticket.project = project;

      const projectCollection: IProject[] = [{ id: 18013 }];
    ...
    it('Should call User query and add missing value', () => {
      const ticket: ITicket = { id: 456 };
      const assignedTo: IUser = { id: 30431 };
      ticket.assignedTo = assignedTo;

      const userCollection: IUser[] = [{ id: 670 }];
    ...
    it('Should call Label query and add missing value', () => {
      const ticket: ITicket = { id: 456 };
      const labels: ILabel[] = [{ id: 19048 }];
      ticket.labels = labels;

      const labelCollection: ILabel[] = [{ id: 12531 }];
    ...
    it('Should update editForm', () => {
      const ticket: ITicket = { id: 456 };
      const project: IProject = { id: 11542 };
      ticket.project = project;
      const assignedTo: IUser = { id: 13720 };
      ticket.assignedTo = assignedTo;
      const label: ILabel = { id: 17152 };
      ticket.labels = [label];
